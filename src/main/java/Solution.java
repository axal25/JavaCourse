...
public class Solution {
    ...
    public static int firstToSecondCount = 0;
    public static int secondToFistCount = 0;
    public static int firstToSecondSuccesses = 0;
    public static int secondToFistSuccesses = 0;
    public static int complexSuccesses = 0;
    ...
    public static class DeserializerFirst extends StdDeserializer<First> {
        protected DeserializerFirst(Class<?> classVariable) {
            super(classVariable);
    ...
    public static class SerializerFirst extends StdSerializer<First> {
        protected SerializerFirst(Class<First> firstClass) {
            super(firstClass);
